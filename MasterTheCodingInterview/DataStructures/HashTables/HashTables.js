// Hash tables or hash map or objects are one of the most common data structures out there. It uses key-value pairs in order to store data and uses the key as an index for the item.
